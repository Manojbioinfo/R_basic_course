...
**Figure 1.** Co-occurrence network of R programming applications in biomedical research (2000-2026). This VOSviewer visualization (v1.6.19) maps 200 high-frequency terms from 15,342 PubMed-indexed articles (PMIDs) mentioning "R" in methods/analysis sections.
